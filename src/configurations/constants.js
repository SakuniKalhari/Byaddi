...
export const fontFamilies = {
    ...
    candaraRegular: Platform.OS === 'ios' ? 'Candara':'Candara-Regular',
    ...
    GillSansMTBold: 'Gill Sans MT Bold',
    SFProTextRegular: 'FontsFree-Net-SFProText-Regular',
    Stcaiyun:'chinese.stcaiyun',
    Humanst521BT: 'Humanst521 BT',
